...
{
    //the simplest one
    //return 1/Pow2(1.0+q2/0.71);
    //kelly
    //double tofm = 25.68189504;
    //double x = q2*tofm;
    //double A=1./(tofm*4.*(M2));
    //
    //double p0 = -0.24*A;
    //double p1 = 10.98*A;
    //double p2 = 12.82*A*A;
...
{
    //simple one
    //return 2.79*1/Pow2(1+q2/0.71);
    //Kelly form factor of proton
    //double a11_K = -0.24; // Electric form factor
    //double b11_K = 10.98;
    //double b12_K = 12.82;
    //double b13_K = 21.97;

    //double a21_K = 0.12; // Magnetic form factor
    //double b21_K = 10.97;
    //double b22_K = 18.86;
    //double b23_K = 6.55;
    ///*return the Kelly magnetic form factor value at Q2 (GeV^2)*/
    //double t = fabs(q2) / (4. * (M2)); // Tau
    ...
    //return mu*(1./(1. + p2*q2 + p4*q2*q2 + p6*Pow3(q2) + p8*Pow4(q2) + p10*Pow5(q2) + p12*Pow6(q2) ) );
    //Arrington2007
    double b1 = 3.173;
    double b2 = -0.314;
    double b3 = -1.165;
    ...
    double b5 = -1.087;
    double f5 = 1. + b5*q2;
    double f4 = 1. + b4*q2/f5;
    double f3 = 1. + b3*q2/f4;
    double f2 = 1. + b2*q2/f3;
    double f1 = 1. + b1*q2/f2;
